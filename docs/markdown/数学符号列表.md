...
|  $A  \backslash  B$ | relative complement  |  bjects that belong to A and not to B |  A  \backslash  B |   $A=\lbrace 3,9,14 \rbrace$<br>$A=\lbrace 1,2,3 \rbrace$<br>$A\backslash B=\lbrace 9,14 \rbrace$  |
